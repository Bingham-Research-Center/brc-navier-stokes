...
\end{itemize}
All three notes were retired in the 2026-07-27 curation; they are
recoverable from Git history before commit \texttt{13557eb}, per the
recipe in \texttt{dossier/records/README.md}.
