...
| **adjoint_pressure_nonlinear_regeneration.py** | Reciprocal-frequency summation, remote heat-erasure powers, and the physical \(E_nH_n^{-3/4}\sim\rho_n\) ledger | Littlewood--Paley/Duhamel identities or finiteness of the nonlinear regeneration action |
| **adjoint_pressure_parabolic_regeneration.py** | One-heat-time shell summation, physical zoom cancellation, and the macroscopic-shell absolute-continuity ceiling | Duhamel/Lorentz estimates, spatial source localisation, or finiteness of recent regeneration |
